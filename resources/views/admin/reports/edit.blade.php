...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="card-box">
                    <h4 class="header-title"><i class=" mdi mdi-information-outline" data-toggle="tooltip" data-placement="top" title=" Tin người dùng đăng : Là những bài báo cáo được người gửi lên có nội dung yêu cầu hỗ trợ thú
            ...
            <div class="col-lg-5">
                <form action="{{route('create_admin_report_new')}}" id="product_form" method="POST"
                    ...
                    @csrf
                    <div class="card-box">
                        <h4 class="header-title"><i class=" mdi mdi-information-outline" data-toggle="tooltip" data-placement="bottom" title="Thú nuôi liên quan tới bài viết!"></i> Thú nuôi liên quan : </h4>
                        <div>
                            {{--                        {{dd($report_pet_id)}}--}}
                            <div class="form-group">
                    ...
                    <div class="card-box">
                        <h4 class="header-title"><i class=" mdi mdi-information-outline"  data-toggle="tooltip" data-placement="bottom" title="Admin đăng bài sau khi cập nhật trạng thái của báo cáo"></i> Bài viết admin : </h4>
