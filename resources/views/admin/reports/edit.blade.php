        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <div id="product_form" method="POST" class="parsley-examples" novalidate="">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group" style="width:10%;">
                            ...
                            <select name="Status" class="form-control select-form-control" @if ($report->Status == 2 ) disabled @endif>
                                <option value="0"  @if ( $report->Status == 0 ) select @endif @if ( $report->Status != 0 ) disabled @endif > Chưa xử lý </option>
                        ...
                        @foreach($report->ArrayThumbnails as $thumbnail)
                            <input type="hidden" name="thumbnails[]" data-cloudinary-public-id="{{$thumbnail}}" value="{{$thumbnail}}">
                        @endforeach
                        <div class="form-group text-right mb-0">
                            <a class="btn btn-primary waves-effect waves-light mr-1" href="{{route('admin_report_edit',$report->id)}}">
                                Cập nhật
                            </a>
