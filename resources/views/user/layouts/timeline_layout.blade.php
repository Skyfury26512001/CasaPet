...
<section class="cd-h-timeline js-cd-h-timeline margin-bottom-md">
    <p class="text-center margin-top-md margin-bottom-xl">👈 <a class="text--inherit"
                                                                href="https://codyhouse.co/gem/horizontal-timeline/">Article
            &amp; Download</a></p>
    ...
    <div class="cd-h-timeline__container container">
        <div class="cd-h-timeline__dates">
            <div class="cd-h-timeline__line">
                <ol>
                    <li><a href="#" data-date="16/01/2014"
                           class="cd-h-timeline__date cd-h-timeline__date--selected">16
                            Jan</a></li>
                    <li><a href="#" data-date="28/02/2014" class="cd-h-timeline__date">28 Feb</a></li>
                    <li><a href="#" data-date="20/04/2014" class="cd-h-timeline__date">20 Mar</a></li>
                    <li><a href="#" data-date="20/05/2014" class="cd-h-timeline__date">20 May</a></li>
                    <li><a href="#" data-date="09/07/2014" class="cd-h-timeline__date">09 Jul</a></li>
                    <li><a href="#" data-date="30/08/2014" class="cd-h-timeline__date">30 Aug</a></li>
                    <li><a href="#" data-date="15/09/2014" class="cd-h-timeline__date">15 Sep</a></li>
                    <li><a href="#" data-date="01/11/2014" class="cd-h-timeline__date">01 Nov</a></li>
                    <li><a href="#" data-date="10/12/2014" class="cd-h-timeline__date">10 Dec</a></li>
                    <li><a href="#" data-date="19/01/2015" class="cd-h-timeline__date">29 Jan</a></li>
                    <li><a href="#" data-date="03/03/2015" class="cd-h-timeline__date">3 Mar</a></li>
                </ol>
        ...
        <ul>
            ...
            <li><a href="#" class="text-replace cd-h-timeline__navigation cd-h-timeline__navigation--next">Next</a>
            </li>
        </ul>
...
<script src={{asset('assets/user/js/swipe-content.js')}}></script>
